...
Use for one small bug fix or obvious change. If the task spans multiple subsystems, touches more than a few files, or needs product/architecture decisions, switch to `task-small-feature` or `task-prd`.
