...
Use when the request is clear, limited, and does not need a full PRD. If scope expands beyond roughly 1-3 files or requires architecture/product choices, move to `task-prd`.
